...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @fb_ctor__max, i8* null }]

; Function Attrs: norecurse nounwind readnone
define i32 @MAX(i32 %"A$1", i32 %"B$1") #0 {
  %1 = icmp sgt i32 %"A$1", %"B$1"
  %"A$1.B$1" = select i1 %1, i32 %"A$1", i32 %"B$1"
  ret i32 %"A$1.B$1"
}
...
define i32 @MAIN() #1 {
  ...
  tail call void @fb_PrintInt(i32 0, i32 30, i32 1) #3
  ret i32 0
}
...
; Function Attrs: nounwind
define internal void @fb_ctor__max() #1 {
  %1 = tail call i32 @fb_Color(i32 0, i32 2, i32 0) #3
  tail call void @fb_PrintInt(i32 0, i32 30, i32 1) #3
  ret void
}
