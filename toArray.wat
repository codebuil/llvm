...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @fb_ctor__toArray, i8* null }]

; Function Attrs: nounwind
define internal void @fb_ctor__toArray() #0 {
...
; <label>:10                                      ; preds = %.lr.ph, %9
  ...
  %11 = call %struct.FBSTRING* @fb_StrAllocTempDescZEx(i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), i32 1) #3
  call void @fb_PrintString(i32 0, %struct.FBSTRING* %11, i32 0) #3
  %12 = add nuw nsw i32 %"B$0.01", 1
  %13 = call %struct.FBSTRING* @fb_StrMid(%struct.FBSTRING* nonnull %"S$0", i32 %12, i32 1) #3
  call void @fb_PrintString(i32 0, %struct.FBSTRING* %13, i32 0) #3
  %14 = call %struct.FBSTRING* @fb_StrAllocTempDescZEx(i8* nonnull getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32 2) #3
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %10
  ...
  %"B$0.01" = phi i32 [ %12, %10 ], [ 0, %.lr.ph.preheader ]
