...
static void fb_ctor__toArray( void ) __attribute__(( constructor ));

__attribute__(( constructor )) static void fb_ctor__toArray( void )
{
	label$0:;
	int32 A$0;
	...
	A$0 = 0;
	{
		...
		label$5:;
		{
			...
			label$7:;
			label$6:;
			FBSTRING* vr$10 = fb_StrAllocTempDescZEx( (uint8*)"'", 1 );
			fb_PrintString( 0, (FBSTRING*)vr$10, 0 );
			FBSTRING* vr$13 = fb_StrMid( (FBSTRING*)&S$0, B$0 + 1, 1 );
			fb_PrintString( 0, (FBSTRING*)vr$13, 0 );
			FBSTRING* vr$14 = fb_StrAllocTempDescZEx( (uint8*)"',", 2 );
